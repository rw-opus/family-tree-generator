...
describe("GEDCOM import", () => {
  it("imports individuals, dates and parent links", () => {
    ...
    expect(joseph).toMatchObject({ dateOfBirth: "1940-02-02", dateOfDeath: "2020-10-10", isDeceased: true });
    expect(anna).toMatchObject({ fatherId: joseph.id, motherId: maria.id, dateOfBirth: "1970-03-12" });
